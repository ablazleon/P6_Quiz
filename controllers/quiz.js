...
exports.index = (req, res, next) => {
    ...
    if (req.user){
        ...
        if( req.session.user && req.session.user.id === req.user.id){ // Why not ===
            title = "My Questions";
        }else {
    ...
    .then(count => {
        ...
        // It have been written the options before.
        const findOptions = {
            ...countOptions,
